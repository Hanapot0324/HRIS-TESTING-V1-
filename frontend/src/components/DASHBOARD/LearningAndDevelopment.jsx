...
const Bone = ({ w = '100%', h = 14, r = 6, sx = {} }) => (
  <Box
    sx={{
      ...
      animation: 'ldShimmer 1.6s infinite linear',
      flexShrink: 0,
      ...sx,
    }}
  />
          ...
          <Grid item xs={12} lg={col === 0 ? 4 : 8} key={col}>
            <Box
              sx={{
                ...
                bgcolor: '#fff',
                overflow: 'hidden',
                animation: `ldPulse 2s ease-in-out ${col * 0.1}s infinite`,
...
const LearningAndDevelopment = () => {
  ...
  const { hasAccess } = usePageAccess('learningdev');
  ...
  useEffect(() => {
    fetchLearning().finally(() => setPageLoading(false));
  }, []); // eslint-disable-line react-hooks/exhaustive-deps

  useEffect(() => {
    refreshRef.current = fetchLearning;
  });

  useEffect(() => {
    if (!socket || !connected) return;
    const handler = () => refreshRef.current?.();
    socket.on('learningChanged', handler);
    return () => socket.off('learningChanged', handler);
  }, [socket, connected]);
  ...
  const fetchLearning = async () => {
    ...
    try {
      ...
      showSnackbar('Failed to fetch learning and development records.', 'error');
    } finally {
      setLoading(false);
    }
  };
  ...
  const filteredData = useMemo(() => {
    ...
    return groupedData.filter(
      (g) =>
        ...
        g.records.some(
          (r) =>
            (r.titleOfProgram || '').toLowerCase().includes(q) ||
            (r.typeOfLearningDevelopment || '').toLowerCase().includes(q) ||
            (r.conductedSponsored || '').toLowerCase().includes(q)
        )
    );
  ...
  const validateAdd = () => {
    const errs = {};
    if (!newLearning.person_id) errs.person_id = 'Required';
    if (!newLearning.titleOfProgram?.trim()) errs.titleOfProgram = 'Required';
    if (!newLearning.dateFrom) errs.dateFrom = 'Required';
    if (!newLearning.dateTo) errs.dateTo = 'Required';
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      showSnackbar(
        err.response?.data?.error || 'Failed to add learning and development record.',
        'error'
      );
      setLoading(false);
    }
  ...
  const handleUpdate = async () => {
    ...
    if (
      tempRecordData.dateFrom &&
      tempRecordData.dateTo &&
      new Date(tempRecordData.dateFrom) > new Date(tempRecordData.dateTo)
    ) {
    ...
    try {
      await axios.put(
        `${API_BASE_URL}/learning_and_development_table/${tempRecordData.id}`,
        tempRecordData,
        getAuthHeaders()
      );
      ...
      showSnackbar('Failed to update learning and development record.', 'error');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(
        `${API_BASE_URL}/learning_and_development_table/${selectedRecord.id}`,
        getAuthHeaders()
      );
      ...
      showSnackbar('Failed to delete learning and development record.', 'error');
    } finally {
      setLoading(false);
    }
  };
  ...
  const canAdd =
    !loading &&
    !!newLearning.person_id &&
    !!newLearning.titleOfProgram?.trim() &&
    !!newLearning.dateFrom &&
    !!newLearning.dateTo;
  ...
  if (hasAccess === false) {
    return (
      <AccessDenied
        title="Access Denied"
        message="You do not have permission to access Learning and Development Information."
  ...
  if (pageLoading) return <LdWireframe />;
    ...
    <>
      ...
      <Fade in timeout={400}>
        ...
        >
          <LoadingOverlay
            open={loading}
            message="Processing learning and development record..."
          />
          <SuccessfulOverlay
            open={successOpen}
          ...
          <SectionCard sx={{ mb: 2, overflow: 'hidden' }}>
            ...
            >
              ...
              >
                <LightbulbIcon sx={{ fontSize: 32, color: T.accent }} />
                <Box>
                  <Typography
                    sx={{
                      fontSize: '1.25rem',
                  ...
                  >
                    Administrative Panel • Add and manage L&D records for employees
                  </Typography>
                </Box>
              </Box>
              <Box
              ...
              >
                ...
                <DashboardModuleAuditLogs tableName="learning_and_development_table" moduleLabel="Learning and Development" />
                ...
                >
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <EmployeeAutocomplete
                      ...
                      onChange={(val) => {
                        setNewLearning((r) => ({ ...r, person_id: val }));
                        setErrors((e) => {
                          const n = { ...e };
                          delete n.person_id;
                          return n;
                  ...
                  <FormSectionLabel icon={LightbulbIcon}>Learning Details</FormSectionLabel>

                  <Box sx={{ mb: 2 }}>
                    <Typography
                      sx={{ fontSize: '0.75rem', fontWeight: 600, color: T.accent, mb: 0.75 }}
                    >
                      Title of Program <Box component="span" sx={{ color: '#c62828' }}>*</Box>
                    </Typography>
                    <FieldInput
                      value={newLearning.titleOfProgram}
                      onChange={(e) => {
                        setNewLearning((r) => ({ ...r, titleOfProgram: e.target.value }));
                        setErrors((er) => {
                          const n = { ...er };
                          delete n.titleOfProgram;
                          return n;
                        });
                      }}
                      fullWidth
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <FieldInput
                      ...
                      onChange={(e) => {
                        setNewLearning((r) => ({ ...r, dateFrom: e.target.value }));
                        setErrors((er) => {
                          const n = { ...er };
                          delete n.dateFrom;
                          return n;
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <FieldInput
                      ...
                      onChange={(e) => {
                        setNewLearning((r) => ({ ...r, dateTo: e.target.value }));
                        setErrors((er) => {
                          const n = { ...er };
                          delete n.dateTo;
                          return n;
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <FieldInput
                      ...
                      onChange={(e) =>
                        setNewLearning((r) => ({ ...r, numberOfHours: e.target.value }))
                      }
                      fullWidth
                      size="small"
                    />
                  ...
                  <Box sx={{ mt: 'auto' }}>
                    {(selectedEmployee || newLearning.titleOfProgram) && (
                      <AccentButton
                        onClick={() => {
                          setNewLearning({
                            titleOfProgram: '',
                    ...
                    >
                      {loading ? 'Adding...' : 'Add Learning Record'}
                    </AccentButton>
                  </Box>
                </Box>
              </SectionCard>
            ...
            <Grid item xs={12} lg={8}>
              ...
              >
                ...
                >
                  ...
                  <FieldInput
                    size="small"
                    placeholder="Search by employee ID, name, title, type, or sponsor..."
                    value={searchTerm}
                ...
                >
                  {pagedData.length === 0 ? (
                    <Box sx={{ py: 10, textAlign: 'center' }}>
                      ...
                      >
                        <LightbulbIcon sx={{ fontSize: 32, color: alpha(T.accent, 0.3) }} />
                      </Box>
                      <Typography
                      ...
                      <Typography sx={{ fontSize: '0.78rem', color: T.faint }}>
                        {groupedData.length === 0
                          ? 'Use the form on the left to add a learning record.'
                ...
                >
                  ...
                  >
                    ...
                    <Box>
                      ...
                      >
                        Learning Records of {modalState.employeeName}
                      </Typography>
                ...
                <Box sx={{ flexGrow: 1, display: 'flex', overflow: 'hidden' }}>
                      ...
                      {modalState.records.map((record) => (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {record.titleOfProgram?.charAt(0)?.toUpperCase() || '?'}
                            </Avatar>
                            <Box sx={{ minWidth: 0 }}>
                              <Typography
                                ...
                                noWrap
                              >
                                {record.titleOfProgram || 'Untitled'}
                              </Typography>
                              <Typography sx={{ fontSize: '0.68rem', color: T.muted }} noWrap>
                                {formatDateDisplay(record.dateFrom)} - {formatDateDisplay(record.dateTo)}
                              </Typography>
                            </Box>
                          </Box>
                        </ListItem>
                  ...
                  <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                    {selectedRecord ? (
                          ...
                          {!isEditingRecord ? (
                            <>
                              ...
                              >
                                ...
                                >
                                  {selectedRecord.titleOfProgram?.charAt(0)?.toUpperCase() || '?'}
                                </Avatar>
                                <Typography
                                  sx={{
                                    fontSize: '1.1rem',
                                ...
                                >
                                  {selectedRecord.titleOfProgram || 'Untitled Program'}
                                </Typography>
                                <Typography
                                  sx={{ fontSize: '0.78rem', color: T.accentMid, mt: 0.5 }}
                                >
                                  {formatDateDisplay(selectedRecord.dateFrom)} - {formatDateDisplay(selectedRecord.dateTo)}
                                </Typography>
                              </Box>

                              <Box sx={{ px: 3.5, py: 2.5 }}>
                                {[
                                  { label: 'Title of Program', value: selectedRecord.titleOfProgram },
                                  ...
                                  { label: 'Number of Hours', value: selectedRecord.numberOfHours || '-' },
                                  {
                                    label: 'Type of Learning Development',
                                    value: selectedRecord.typeOfLearningDevelopment || '-',
                                  },
                                  {
                                    label: 'Conducted/Sponsored By',
                                    value: selectedRecord.conductedSponsored || '-',
                                  },
                            ...
                            <Box sx={{ px: 3.5, py: 3 }}>
                              ...
                              <Box sx={{ mb: 2 }}>
                                ...
                                <FieldInput
                                  value={tempRecordData.titleOfProgram}
                                  onChange={(e) =>
                                    setTempRecordData((r) => ({
                                      ...r,
                              ...
                              <Box sx={{ mb: 2 }}>
                                ...
                                <FieldInput
                                  value={tempRecordData.typeOfLearningDevelopment || ''}
                                  onChange={(e) =>
                                    setTempRecordData((r) => ({
                                      ...r,
                                      typeOfLearningDevelopment: e.target.value,
                              ...
                              <Box sx={{ mb: 2 }}>
                                ...
                                <FieldInput
                                  value={tempRecordData.conductedSponsored || ''}
                                  onChange={(e) =>
                                    setTempRecordData((r) => ({
                                      ...r,
                                      conductedSponsored: e.target.value,
                      ...
                      >
                        <LightbulbIcon sx={{ fontSize: 40, color: alpha(T.accent, 0.2) }} />
                        <Typography
